---
hide_title: true
sidebar_label: Bugsink
title: Bugsink | Self-Host on Easypanel
description: How to install Bugsink on Easypanel? 1-Click installation template for Bugsink on Easypanel
---
...
![Bugsink Screenshot](./assets/screenshot.png)
