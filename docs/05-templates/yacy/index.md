...
hide_title: true
sidebar_label: YaCy
title: YaCy | Self-Host on Easypanel
description: How to install YaCy on Easypanel? 1-Click installation template for YaCy on Easypanel
---
...
![YaCy Screenshot](./assets/screenshot.png)
