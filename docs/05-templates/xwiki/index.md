...
App Service Image | XWiki Docker image with PostgreSQL support | yes | xwiki:18.2.1-postgres-tomcat
...
- 2026-02-24 – Version bumped to 18.1.0-postgres-tomcat
- 2026-05-07 – Version bumped to 18.2.1-postgres-tomcat
