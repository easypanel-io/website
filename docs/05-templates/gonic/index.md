...
hide_title: true
sidebar_label: Gonic
title: Gonic | Self-Host on Easypanel
description: How to install Gonic on Easypanel? 1-Click installation template for Gonic on Easypanel
---
...
![Gonic Screenshot](./assets/screenshot.png)
