---
hide_title: true
sidebar_label: PgHero
title: PgHero | Self-Host on Easypanel
description: How to install PgHero on Easypanel? 1-Click installation template for PgHero on Easypanel
---
...
![PgHero Screenshot](./assets/screenshot.png)
