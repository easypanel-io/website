...
App Service Image | - | yes | bbilly1/tubearchivist:v0.5.10
Elasticsearch Service Image | - | yes | bbilly1/tubearchivist-es:8.19.0
Redis Service Image | - | yes | redis/redis-stack-server:7.4.0-v8
Username | - | yes | admin
...
- 2026-05-07 – Version bumped to v0.5.10, 8.19.0
