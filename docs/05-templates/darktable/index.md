---
hide_title: true
sidebar_label: Darktable
title: Darktable | Self-Host on Easypanel
description: How to install Darktable on Easypanel? 1-Click installation template for Darktable on Easypanel
---
...
![Darktable Screenshot](./assets/screenshot.png)
