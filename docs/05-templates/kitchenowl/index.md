...
title: KitchenOwl | Self-Host on Easypanel
description: How to install KitchenOwl on Easypanel? 1-Click installation template for KitchenOwl on Easypanel
---
...
![KitchenOwl Screenshot](./assets/screenshot.png)
