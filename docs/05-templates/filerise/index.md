...
title: Filerise | Self-Host on Easypanel
description: How to install Filerise on Easypanel? 1-Click installation template for Filerise on Easypanel
---
...
![Filerise Screenshot](./assets/screenshot.png)
