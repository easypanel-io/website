...
title: Obsidian | Self-Host on Easypanel
description: How to install Obsidian on Easypanel? 1-Click installation template for Obsidian on Easypanel
---
...
![Obsidian Screenshot](./assets/screenshot.png)
